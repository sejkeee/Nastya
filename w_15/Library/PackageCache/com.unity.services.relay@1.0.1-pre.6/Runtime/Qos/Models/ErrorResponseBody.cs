...
namespace Unity.Services.Relay.Qos.Models
{
    ...
    /// <param name="type">A URI representing the type of error.</param>
    /// <param name="code">A QoS specific error code in the range of [0,999].</param>
    /// </summary>
    ...
    internal class ErrorResponseBody
    {
        ...
        /// <summary>
        /// A URI representing the type of error.
        /// </summary>
        [Preserve]
        [DataMember(Name = "type", IsRequired = true, EmitDefaultValue = true)]
        public string Type{ get; }
        /// <summary>
        /// A QoS specific error code in the range of [0,999].
        /// </summary>
        [Preserve]
