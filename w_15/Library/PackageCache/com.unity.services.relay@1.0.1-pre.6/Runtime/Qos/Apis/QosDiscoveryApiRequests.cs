...
namespace Unity.Services.Relay.Qos.QosDiscovery
{
    ...
    internal class GetServersRequest : QosDiscoveryApiBaseRequest
    {
        ...
        /// Get Servers
        /// </summary>
        /// <param name="region">Regions to filter on the returned list of QoS servers.  Multiple values can be passed using multiple query parameters, i.e. ?region=us-east1&region=europe-west2  i.e. providing us-east1 and europe-west2 will return only the QoS servers in those regions for the specified service.  If no region is specified, QoS servers from all regions that match the other filters will be included in the response.</param>
        /// <param name="service">Service for which the client is requesting QoS servers. Valid values are:   - relay   - multiplay</param>
        [Preserve]
